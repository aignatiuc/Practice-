    ...
    <div v-else class="container flex flex-wrap mx-auto">
      <div class="text-3xl text-gray-500">
        ...
        <div class="flex grid-cols-2 gap-1 pb-2 mt-2 mb-4 border-b border-gray-100">
          ...
          <span class="text-sm text-gray-300">Viewed {{ question.view_count}}</span>
        </div>
        <p class="pt-2 text-base" v-html="filterQuestionBody"></p>
      ...
      <div v-for="answer in answers" :key="answer.id">
        <div class="mt-4 mb-4" v-html="answer.body" />
      </div>
      <div class="container grid grid-cols-1 px-0 mr-4 md:px-24"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    filterQuestionBody() {
      return this.question.body.toString();
    },
    timeAgo() {
